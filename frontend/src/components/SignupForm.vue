    ...
    <div class="form-container">
        <div class="form-input">
            ...
            <div class="field">
                ...
                <div class="control has-icons-left has-icons-right">
                    <input class="input is-danger" type="password" placeholder="Email input" v-model="passwordRep">
                        <span class="icon is-small is-left">
                        <i class="fas fa-envelope"></i>
                            </span>
                            <span class="icon is-small is-right">
            ...
            <div class="field">
                <div class="control">
                    <button class="button is-link" @click="signup">Signup</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        signup: function(event) {
            ...
            let passwordRep = this.passwordRep;
            let employer = this.employer;
            console.log();
            this.resetInputs();
            console.log(employer)
            this.$emit('signup', { email: email, password: password, passwordRep: passwordRep, employer: employer});
        },
