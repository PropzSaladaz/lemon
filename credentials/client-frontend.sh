...
openssl req -newkey rsa:4096 -nodes -keyout frontend-server-key.pem -out frontend-server-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=192.168.1.3/emailAddress=lemon@gmail.pt"
...
openssl req -newkey rsa:4096 -nodes -keyout frontend-client-key.pem -out frontend-client-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=192.168.2.2/emailAddress=lemon@gmail.pt"
