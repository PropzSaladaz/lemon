...
openssl req -newkey rsa:4096 -nodes -keyout mobile-server-key.pem -out mobile-server-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=192.168.2.2/emailAddress=lemon@gmail.pt" -addtext "subjectAltName = IP:192.168.2.2"
...
openssl req -newkey rsa:4096 -nodes -keyout mobile-client-key.pem -out mobile-client-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=192.168.1.2/emailAddress=lemon@gmail.pt" -addtext "subjectAltName = IP:192.168.1.2"
