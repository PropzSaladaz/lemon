...
openssl req -newkey rsa:4096 -nodes -keyout mobile-server-key.pem -out mobile-server-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=localhost/emailAddress=lemon@gmail.pt"
...
openssl req -newkey rsa:4096 -nodes -keyout mobile-client-key.pem -out mobile-client-req.pem -subj "/C=PT/ST=Lisbon/L=Oeiras/O=Lemon/OU=Lemon/CN=localhost/emailAddress=lemon@gmail.pt"
